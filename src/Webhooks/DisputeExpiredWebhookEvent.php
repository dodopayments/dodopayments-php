...
use Dodopayments\Webhooks\DisputeExpiredWebhookEvent\Data;
use Dodopayments\Webhooks\DisputeExpiredWebhookEvent\Type;

/**
 * @phpstan-import-type DataShape from \Dodopayments\Webhooks\DisputeExpiredWebhookEvent\Data
 *
...
final class DisputeExpiredWebhookEvent implements BaseModel
{
     ...
     * ```
     * DisputeExpiredWebhookEvent::with(
