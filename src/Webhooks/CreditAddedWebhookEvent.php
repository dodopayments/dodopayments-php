 ...
 *
 * @phpstan-type CreditAddedWebhookEventShape = array{
 *   businessID: string,
 ...
 * }
 */
final class CreditAddedWebhookEvent implements BaseModel
{
    /** @use SdkModel<CreditAddedWebhookEventShape> */
    use SdkModel;

    /**
     * The event type.
     *
     * @var 'credit.added' $type
     */
    #[Required]
    public string $type = 'credit.added';
    ...
    /**
     * `new CreditAddedWebhookEvent()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * CreditAddedWebhookEvent::with(businessID: ..., data: ..., timestamp: ...)
     * ```
     *
     * Otherwise ensure the following setters are called
     *
     * ```
     * (new CreditAddedWebhookEvent)
     *   ->withBusinessID(...)
     *   ->withData(...)
     *   ->withTimestamp(...)
     * ```
