...
final class PaymentProcessingWebhookEvent implements BaseModel
{
     ...
     * The event type.
     *
     * @var 'payment.processing' $type
     */
    #[Required]
    public string $type = 'payment.processing';
     ...
     * ```
     * PaymentProcessingWebhookEvent::with(businessID: ..., data: ..., timestamp: ...)
     * ```
     *
