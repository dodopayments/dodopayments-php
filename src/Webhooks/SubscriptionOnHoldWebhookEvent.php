...
use Dodopayments\Webhooks\SubscriptionOnHoldWebhookEvent\Type;

/**
 * @phpstan-type subscription_on_hold_webhook_event = array{
 *   businessID: string,
 *   data: Data,
...
{
    /** @use SdkModel<subscription_on_hold_webhook_event> */
    use SdkModel;
     ...
     * ```
     * SubscriptionOnHoldWebhookEvent::with(
