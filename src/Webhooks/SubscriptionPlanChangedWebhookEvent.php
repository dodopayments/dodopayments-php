...
use Dodopayments\Webhooks\SubscriptionPlanChangedWebhookEvent\Type;

/**
 * @phpstan-type subscription_plan_changed_webhook_event = array{
 *   businessID: string,
 *   data: Data,
...
{
    /** @use SdkModel<subscription_plan_changed_webhook_event> */
    use SdkModel;
