 ...
 *
 * @phpstan-type CreditDeductedWebhookEventShape = array{
 *   businessID: string,
 ...
 * }
 */
final class CreditDeductedWebhookEvent implements BaseModel
{
    /** @use SdkModel<CreditDeductedWebhookEventShape> */
    use SdkModel;

    /**
     * The event type.
     *
     * @var 'credit.deducted' $type
     */
    #[Required]
    public string $type = 'credit.deducted';
    ...
    /**
     * `new CreditDeductedWebhookEvent()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * CreditDeductedWebhookEvent::with(businessID: ..., data: ..., timestamp: ...)
     * ```
     *
     * Otherwise ensure the following setters are called
     *
     * ```
     * (new CreditDeductedWebhookEvent)
     *   ->withBusinessID(...)
     *   ->withData(...)
     *   ->withTimestamp(...)
     * ```
