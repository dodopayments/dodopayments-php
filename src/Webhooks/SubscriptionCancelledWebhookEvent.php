...
use Dodopayments\Webhooks\SubscriptionCancelledWebhookEvent\Data;

/**
 * @phpstan-import-type DataShape from \Dodopayments\Webhooks\SubscriptionCancelledWebhookEvent\Data
 *
...
final class SubscriptionCancelledWebhookEvent implements BaseModel
{
     ...
     * The event type.
     *
     * @var 'subscription.cancelled' $type
     */
    #[Required]
    public string $type = 'subscription.cancelled';
     ...
     * The event type.
     *
     * @param 'subscription.cancelled' $type
     */
