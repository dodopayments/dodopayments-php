...
use Dodopayments\Webhooks\EntitlementGrantCreatedWebhookEvent\Data;
use Dodopayments\Webhooks\EntitlementGrantCreatedWebhookEvent\Type;

/**
 * @phpstan-import-type DataShape from \Dodopayments\Webhooks\EntitlementGrantCreatedWebhookEvent\Data
 *
 * @phpstan-type EntitlementGrantCreatedWebhookEventShape = array{
 *   businessID: string,
 *   data: Data|DataShape,
...
final class EntitlementGrantCreatedWebhookEvent implements BaseModel
{
     ...
     *
     * ```
     * (new EntitlementGrantCreatedWebhookEvent)
     *   ->withBusinessID(...)
     *   ->withData(...)
     *   ->withTimestamp(...)
     *   ->withType(...)
