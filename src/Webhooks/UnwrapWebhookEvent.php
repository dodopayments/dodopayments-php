 ...
 * @phpstan-import-type PayoutCreatedWebhookEventShape from \Dodopayments\Webhooks\PayoutCreatedWebhookEvent
 * @phpstan-import-type PayoutFailedWebhookEventShape from \Dodopayments\Webhooks\PayoutFailedWebhookEvent
 * @phpstan-import-type PayoutInProgressWebhookEventShape from \Dodopayments\Webhooks\PayoutInProgressWebhookEvent
 * @phpstan-import-type PayoutOnHoldWebhookEventShape from \Dodopayments\Webhooks\PayoutOnHoldWebhookEvent
 * @phpstan-import-type PayoutSuccessWebhookEventShape from \Dodopayments\Webhooks\PayoutSuccessWebhookEvent
 ...
 * @phpstan-import-type SubscriptionPastDueWebhookEventShape from \Dodopayments\Webhooks\SubscriptionPastDueWebhookEvent
 * @phpstan-import-type SubscriptionPausedWebhookEventShape from \Dodopayments\Webhooks\SubscriptionPausedWebhookEvent
...
final class UnwrapWebhookEvent implements ConverterSource
{
    ...
    public static function variants(): array
    {
        return [
            ...
            'payout.created' => PayoutCreatedWebhookEvent::class,
            'payout.failed' => PayoutFailedWebhookEvent::class,
            'payout.in_progress' => PayoutInProgressWebhookEvent::class,
            'payout.on_hold' => PayoutOnHoldWebhookEvent::class,
            'payout.success' => PayoutSuccessWebhookEvent::class,
            ...
            'subscription.past_due' => SubscriptionPastDueWebhookEvent::class,
            'subscription.paused' => SubscriptionPausedWebhookEvent::class,
            ...
            'subscription.unpaused' => SubscriptionUnpausedWebhookEvent::class,
            'subscription.update_payment_method' => SubscriptionUpdatePaymentMethodWebhookEvent::class,
