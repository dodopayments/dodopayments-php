...
use Dodopayments\Entitlements\Grants\EntitlementGrant\Feature;
 ...
 * @phpstan-import-type FeatureShape from \Dodopayments\Entitlements\Grants\EntitlementGrant\Feature
...
final class EntitlementGrant implements BaseModel
{
     ...
     * @param Feature|FeatureShape|null $feature
     */
    public function withFeature(Feature|array|null $feature): self
    {
        $self = clone $this;
