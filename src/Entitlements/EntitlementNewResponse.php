...
use Dodopayments\Entitlements\EntitlementNewResponse\IntegrationType;

/**
 * @phpstan-import-type IntegrationConfigVariants from \Dodopayments\Entitlements\EntitlementNewResponse\IntegrationConfig
 * @phpstan-import-type IntegrationConfigShape from \Dodopayments\Entitlements\EntitlementNewResponse\IntegrationConfig
 *
 * @phpstan-type EntitlementNewResponseShape = array{
 *   id: string,
 *   businessID: string,
 ...
 * }
 */
final class EntitlementNewResponse implements BaseModel
{
    /** @use SdkModel<EntitlementNewResponseShape> */
    use SdkModel;
    ...
    /**
     * `new EntitlementNewResponse()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * EntitlementNewResponse::with(
     *   id: ...,
     *   businessID: ...,
     *   createdAt: ...,
     *   integrationConfig: ...,
