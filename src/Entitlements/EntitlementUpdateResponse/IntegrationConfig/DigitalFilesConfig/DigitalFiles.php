...
namespace Dodopayments\Entitlements\EntitlementUpdateResponse\IntegrationConfig\DigitalFilesConfig;

use Dodopayments\Core\Attributes\Optional;
use Dodopayments\Core\Attributes\Required;
use Dodopayments\Core\Concerns\SdkModel;
use Dodopayments\Core\Contracts\BaseModel;
use Dodopayments\Entitlements\EntitlementUpdateResponse\IntegrationConfig\DigitalFilesConfig\DigitalFiles\File;
 ...
 * (`legacy` vs `ee`).
 *
 * @phpstan-import-type FileShape from \Dodopayments\Entitlements\EntitlementUpdateResponse\IntegrationConfig\DigitalFilesConfig\DigitalFiles\File
 *
