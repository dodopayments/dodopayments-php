...
use Dodopayments\Entitlements\EntitlementListResponse\IntegrationType;

/**
 * @phpstan-import-type IntegrationConfigVariants from \Dodopayments\Entitlements\EntitlementListResponse\IntegrationConfig
 * @phpstan-import-type IntegrationConfigShape from \Dodopayments\Entitlements\EntitlementListResponse\IntegrationConfig
 *
 * @phpstan-type EntitlementListResponseShape = array{
 *   id: string,
 *   businessID: string,
 ...
 * }
 */
final class EntitlementListResponse implements BaseModel
{
    /** @use SdkModel<EntitlementListResponseShape> */
    use SdkModel;
    ...
    /**
     * `new EntitlementListResponse()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * EntitlementListResponse::with(
     *   id: ...,
     *   businessID: ...,
     *   createdAt: ...,
     *   integrationConfig: ...,
