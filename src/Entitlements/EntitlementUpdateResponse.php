...
use Dodopayments\Entitlements\EntitlementUpdateResponse\IntegrationType;

/**
 * @phpstan-import-type IntegrationConfigVariants from \Dodopayments\Entitlements\EntitlementUpdateResponse\IntegrationConfig
 * @phpstan-import-type IntegrationConfigShape from \Dodopayments\Entitlements\EntitlementUpdateResponse\IntegrationConfig
 *
 * @phpstan-type EntitlementUpdateResponseShape = array{
 *   id: string,
 *   businessID: string,
 ...
 * }
 */
final class EntitlementUpdateResponse implements BaseModel
{
    /** @use SdkModel<EntitlementUpdateResponseShape> */
    use SdkModel;
    ...
    /**
     * `new EntitlementUpdateResponse()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * EntitlementUpdateResponse::with(
     *   id: ...,
     *   businessID: ...,
     *   createdAt: ...,
     *   integrationConfig: ...,
