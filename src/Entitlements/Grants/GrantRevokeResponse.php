...
use Dodopayments\Entitlements\Grants\GrantRevokeResponse\LicenseKey;
use Dodopayments\Entitlements\Grants\GrantRevokeResponse\Status;
 ...
 * @phpstan-import-type LicenseKeyShape from \Dodopayments\Entitlements\Grants\GrantRevokeResponse\LicenseKey
 *
 * @phpstan-type GrantRevokeResponseShape = array{
 *   id: string,
 *   businessID: string,
 ...
 * }
 */
final class GrantRevokeResponse implements BaseModel
{
    /** @use SdkModel<GrantRevokeResponseShape> */
    use SdkModel;
    ...
    /**
     * `new GrantRevokeResponse()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * GrantRevokeResponse::with(
     *   id: ...,
     *   businessID: ...,
     *   createdAt: ...,
     *   customerID: ...,
