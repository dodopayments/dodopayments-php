...
/**
 * @phpstan-type RefundListItemShape = array{
 *   businessID: string,
 ...
 * }
 */
final class RefundListItem implements BaseModel
{
    /** @use SdkModel<RefundListItemShape> */
    use SdkModel;
    ...
    /**
     * `new RefundListItem()` is missing required properties by the API.
     *
