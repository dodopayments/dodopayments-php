 ...
 *
 * @phpstan-type ProductCollectionProductShape = array{
 *   id: string,
 *   addonsCount: int,
 *   filesCount: int,
 ...
 * }
 */
final class ProductCollectionProduct implements BaseModel
{
    /** @use SdkModel<ProductCollectionProductShape> */
    use SdkModel;
    ...
    /**
     * `new ProductCollectionProduct()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * ProductCollectionProduct::with(
     *   id: ...,
     *   addonsCount: ...,
     *   filesCount: ...,
