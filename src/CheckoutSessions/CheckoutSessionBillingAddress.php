...
/**
 * @phpstan-type CheckoutSessionBillingAddressShape = array{
 ...
 * }
 */
final class CheckoutSessionBillingAddress implements BaseModel
{
    /** @use SdkModel<CheckoutSessionBillingAddressShape> */
    use SdkModel;
    ...
    /**
     * `new CheckoutSessionBillingAddress()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * CheckoutSessionBillingAddress::with(country: ...)
     * ```
     *
     * Otherwise ensure the following setters are called
     *
     * ```
     * (new CheckoutSessionBillingAddress)->withCountry(...)
     * ```
     */
