...
namespace Dodopayments\CheckoutSessions\CheckoutSessionPreviewParams\Customization\ThemeConfig;
 ...
 * }
 */
final class Light implements BaseModel
{
    /** @use SdkModel<LightShape> */
    use SdkModel;
