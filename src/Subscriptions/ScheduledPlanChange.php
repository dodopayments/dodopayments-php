...
use Dodopayments\Subscriptions\ScheduledPlanChange\Addon;

/**
 * @phpstan-import-type AddonShape from \Dodopayments\Subscriptions\ScheduledPlanChange\Addon
 *
 * @phpstan-type ScheduledPlanChangeShape = array{
 *   id: string,
 ...
 * }
 */
final class ScheduledPlanChange implements BaseModel
{
    /** @use SdkModel<ScheduledPlanChangeShape> */
    use SdkModel;
    ...
    /**
     * `new ScheduledPlanChange()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * ScheduledPlanChange::with(
     *   id: ...,
     *   addons: ...,
     *   createdAt: ...,
     *   effectiveAt: ...,
