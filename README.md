...
>
> **We'd love your feedback!** Please share any suggestions, bug reports, feature requests, or general thoughts by [filing an issue](https://www.github.com/stainless-sdks/dodo-payments-php/issues/new).
...
```json
{
  "repositories": [
    {
      "type": "vcs",
      "url": "git@github.com:stainless-sdks/dodo-payments-php.git"
    }
  ],
  "require": {
...
See [the contributing documentation](https://github.com/stainless-sdks/dodo-payments-php/tree/main/CONTRIBUTING.md).
